...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url('assets/lib/css/base.min.css')?>">
	<link rel="stylesheet" type="text/css" href="<?=base_url('assets/lib/css/fancy.min.css')?>">
</head>
<script>
/*
