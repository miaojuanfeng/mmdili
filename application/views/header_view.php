	...
	<div class="main-container">
		<div class="main-header">
			...
			<form method="GET" action="/search" id="search-form" class="search-form">
				<input type="text" id="search-input" class="search-input" name="k" value="<?=isset($this->input->get('k'))&&!empty($this->input->get('k'))?$this->input->get('k'):''?>" maxlength="100" placeholder="从海量文档中搜索...">
